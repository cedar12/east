...
impl ByteBuf {
    ...
    pub fn set_u8_be(&mut self, wid: usize, v: u8) -> ByteResult<u8> {
    ...
    pub fn set_u8_le(&mut self, wid: usize, v: u8) -> ByteResult<u8> {
        if (mem::size_of::<u8>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
    ...
    pub fn set_i8_be(&mut self, wid: usize, v: i8) -> ByteResult<i8> {
    ...
    pub fn set_i8_le(&mut self, wid: usize, v: i8) -> ByteResult<i8> {
        if (mem::size_of::<i8>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
        self.copy_from_slice(&mut v.to_le_bytes(), wid);
    ...
    pub fn set_u16_be(&mut self, wid: usize, v: u16) -> ByteResult<u16> {
    ...
    pub fn set_u16_le(&mut self, wid: usize, v: u16) -> ByteResult<u16> {
        if (mem::size_of::<u16>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
        self.copy_from_slice(&mut v.to_le_bytes(), wid);
    ...
    pub fn set_i16_be(&mut self, wid: usize, v: i16) -> ByteResult<i16> {
    ...
    pub fn set_i16_le(&mut self, wid: usize, v: i16) -> ByteResult<i16> {
        if (mem::size_of::<i16>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
        self.copy_from_slice(&mut v.to_le_bytes(), wid);
    ...
    pub fn set_u32_be(&mut self, wid: usize, v: u32) -> ByteResult<u32> {
    ...
    pub fn set_u32_le(&mut self, wid: usize, v: u32) -> ByteResult<u32> {
        if (mem::size_of::<u32>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
        self.copy_from_slice(&mut v.to_le_bytes(), wid);
    ...
    pub fn set_i32_be(&mut self, wid: usize, v: i32) -> ByteResult<i32> {
    ...
    pub fn set_i32_le(&mut self, wid: usize, v: i32) -> ByteResult<i32> {
        if (mem::size_of::<i32>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
        self.copy_from_slice(&mut v.to_le_bytes(), wid);
    ...
    pub fn set_u64_be(&mut self, wid: usize, v: u64) -> ByteResult<u64> {
    ...
    pub fn set_u64_le(&mut self, wid: usize, v: u64) -> ByteResult<u64> {
        if (mem::size_of::<u64>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
        self.copy_from_slice(&mut v.to_le_bytes(), wid);
    ...
    pub fn set_i64_be(&mut self, wid: usize, v: i64) -> ByteResult<i64> {
    ...
    pub fn set_i64_le(&mut self, wid: usize, v: i64) -> ByteResult<i64> {
        if (mem::size_of::<i64>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
        self.copy_from_slice(&mut v.to_le_bytes(), wid);
    ...
    pub fn set_u128_be(&mut self, wid: usize, v: u128) -> ByteResult<u128> {
    ...
    pub fn set_u128_le(&mut self, wid: usize, v: u128) -> ByteResult<u128> {
        if (mem::size_of::<u128>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
        self.copy_from_slice(&mut v.to_le_bytes(), wid);
    ...
    pub fn set_i128_be(&mut self, wid: usize, v: i128) -> ByteResult<i128> {
    ...
    pub fn set_i128_le(&mut self, wid: usize, v: i128) -> ByteResult<i128> {
        if (mem::size_of::<i128>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
        self.copy_from_slice(&mut v.to_le_bytes(), wid);
    ...
    pub fn set_f32_be(&mut self, wid: usize, v: f32) -> ByteResult<f32> {
    ...
    pub fn set_f32_le(&mut self, wid: usize, v: f32) -> ByteResult<f32> {
        if (mem::size_of::<f32>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
        self.copy_from_slice(&mut v.to_le_bytes(), wid);
    ...
    pub fn set_f64_be(&mut self, wid: usize, v: f64) -> ByteResult<f64> {
    ...
    pub fn set_f64_le(&mut self, wid: usize, v: f64) -> ByteResult<f64> {
        if (mem::size_of::<f64>() + wid) > self.capacity {
            return Err(ByteBufError::new("wid out of capacity".to_string()));
        }
        self.copy_from_slice(&mut v.to_le_bytes(), wid);
    ...
    pub fn write_string_with_u8_be_len(&mut self, v: String) -> ByteResult<usize> {
    ...
    pub fn write_string_with_u16_be_len(&mut self, v: String) -> ByteResult<usize> {
    ...
    pub fn write_string_with_u16_le_len(&mut self, v: String) -> ByteResult<usize> {
        if v.as_bytes().len() > u16::MAX as usize {
            return Err(ByteBufError::new("StringLength out of  u8 max_value ".to_string()));
        }
        // write length
    ...
    pub fn write_string_with_u32_be_len(&mut self, v: String) -> ByteResult<usize> {
        if v.as_bytes().len() > u16::MAX as usize {
            return Err(ByteBufError::new("StringLength out of  u8 max_value ".to_string()));
        }
        // write length
    ...
    pub fn write_string_with_u32_le_len(&mut self, v: String) -> ByteResult<usize> {
        if v.as_bytes().len() > u16::MAX as usize {
            return Err(ByteBufError::new("StringLength out of  u8 max_value ".to_string()));
        }
        // write length
